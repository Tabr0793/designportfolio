    ...
    window.tram = function(a) {
        ...
        function i(a, b, c) {
            ...
            void 0 === a)
                return c;
            var d = c;
            return $.test(a) || !_.test(a) ? d = parseInt(a, 10) : _.test(a) && (d = 1e3 * parseFloat(a)),
            0 > d && (d = 0),
            d === d ? d : c
        }
        function j(a) {
        ...
        var l = function(a, b, c) {
            ...
            function g(h, i) {
                function j() {
                    var a = new k;
                    return e(a.init) && a.init.apply(a, arguments),
                    a
                }
                function k() {}
                i === c && (i = h,
                ...
                return n.constructor = j,
                j.mixin = function(b) {
                    return k[a] = j[a] = g(j, b)[a],
                    j
                }
                ,
                j.open = function(a) {
        ...
        var J = b.frame = function() {
          ...
          , L = l(function(b) {
            function d(a, b) {
                ...
                if (!b.weak || !this.props[d]) {
                    var f = e[0]
                      , g = this.props[d];
                    return g || (g = this.props[d] = new f.Bare),
            ...
            function e(a, b, c) {
                if (a) {
                    var e = typeof a;
                    if (b || (this.timer && this.timer.destroy(),
                    this.queue = [],
                    this.active = !1),
                    "number" == e && b)
            ...
            function l(a) {
                ...
                var b;
                "string" == typeof a ? (b = {},
                b[a] = 1) : b = "object" == typeof a && null != a ? a : this.props,
                u.call(this, b, v),
                t.call(this)
            }
            function m(a) {
            ...
            function t() {
                ...
                for (a in this.props)
                    b = this.props[a],
                    b.active && c.push(b.string);
                c = c.join(","),
                this.style !== c && (this.style = c,
                this.el.style[G.transition.dom] = c)
            }
            function u(a, b, e) {
                var f, g, h, i, j = b !== v, k = {};
                for (f in a)
                    h = a[f],
                    f in Z ? (k.transform || (k.transform = {}),
                    k.transform[f] = h) : (s.test(f) && (f = c(f)),
                    f in Y ? k[f] = h : (i || (i = {}),
                    i[f] = h));
                for (f in k) {
                    if (h = k[f],
            ...
            function y(a, c) {
                b[a] = function() {
                    return this.children ? A.call(this, c, arguments) : (this.el && c.apply(this, arguments),
                    this)
                }
            }
            function A(a, b) {
          ...
          , N = l(function(a) {
            ...
            a.init = function(a, b, d, e) {
                ...
                U.fallback || e.fallback ? this.animate = this.fallback : (this.animate = this.transition,
          ...
          , Q = l(N, function(a, b) {
            ...
            a.init = function() {
                ...
                Z.perspective && U.perspective && (this.current.perspective = U.perspective,
          ...
          , R = l(function(b) {
            ...
            b.init = function(a) {
                ...
                void 0 === d && (d = l.to),
                this.unit = a.unit || "",
                "number" == typeof c && "number" == typeof d ? (this.begin = c,
                this.change = d - c) : this.format(d, c),
            ...
            b.render = function(a) {
                ...
                if (c < this.duration) {
                    ...
                    return b = this.startRGB ? k(this.startRGB, this.endRGB, d) : j(this.begin + d * this.change),
          ...
          , T = l(R, function(a, b) {
            a.init = function(a) {
                ...
                for (b in a.values)
                    c = a.values[b],
                    this.current[b] !== c && this.tweens.push(new R({
                        name: b,
                        from: this.current[b],
                        to: c,
                        duration: a.duration,
        ...
        G.transform && G.backface && (Z.z = [w, "translateZ"],
        Z.rotateZ = [x],
        Z.scaleZ = [t],
        Z.perspective = [v]);
        var $ = /ms/
...
Webflow.require('ix').init([{
    ...
    "value": {
        ...
        "triggers": [{
            ...
            "stepsA": [{
                "wait": "1000ms",
                "opacity": 1,
                "transition": "opacity 500ms ease-in 0, transform 1000ms ease 0",
                "x": "0px",
                "y": "0px",
                "z": "0px"
            }],
    ...
    "value": {
        ...
        "triggers": [{
            ...
            "stepsA": [{
                "opacity": 1,
                "transition": "opacity 300ms ease-in 0, transform 800ms ease 0",
                "x": "0px",
                "y": "0px",
                "z": "0px"
            }],
    ...
    "value": {
        ...
        "triggers": [{
            ...
            "stepsA": [{
                "opacity": 1,
                "transition": "transform 500ms ease 0, opacity 200ms ease 0",
                "x": "0px",
                "y": "0px",
                "z": "0px"
            }],
    ...
    "slug": "work-thumbnail-2",
    "name": "Work Thumbnail 2",
    "value": {
        "style": {
            "opacity": 0,
            "x": "0px",
    ...
    "slug": "work-thumbnail-3",
    "name": "Work Thumbnail 3",
    "value": {
        "style": {
            "opacity": 0,
            "x": "0px",
    ...
    "slug": "work-thumbnail-4",
    "name": "Work Thumbnail 4",
    "value": {
        "style": {
            "opacity": 0,
            "x": "0px",
    ...
    "slug": "menu-icon-action",
    "name": "menu icon action",
    "value": {
        "style": {},
        "triggers": [{
            "type": "click",
            ...
            "stepsB": [{
                "opacity": 1,
                "transition": "opacity 90ms ease 0"
            }]
        }, {
            "type": "click",
            "selector": ".line3",
    ...
    "slug": "object-bounce-2",
    "name": "Object bounce 2",
    "value": {
        "style": {},
        "triggers": [{
            "type": "scroll",
    ...
    "value": {
        ...
        "triggers": [{
            ...
            "stepsA": [{
                "opacity": 1,
                "transition": "opacity 200 ease 0, transform 500ms ease 0",
                "x": "0px",
                "y": "0px",
                "z": "0px"
            }],
    ...
    "slug": "about-page-section-reveal",
    "name": "about page section reveal",
    "value": {
        "style": {},
        "triggers": [{
            "type": "scroll",
            "selector": ".about-text-intro",
            "descend": true,
            "offsetTop": "20%",
            "offsetBot": "30%",
            "preserve3d": true,
