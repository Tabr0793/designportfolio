...
;window.Modernizr = function(a, b, c) {
    ...
    var d = "2.7.1", e = {}, f = !0, g = b.documentElement, h = "modernizr", i = b.createElement(h), j = i.style, k, l = {}.toString, m = " -webkit- -moz- -o- -ms- ".split(" "), n = {}, o = {}, p = {}, q = [], r = q.slice, s, t = function(a, c, d, e) {
    ...
    return e.addTest = function(a, b) {
        if (typeof a == "object")
            ...
            typeof f != "undefined" && f && (g.className += " w-mod-" + (b ? "" : "no-") + a),
            e[a] = b
        }
        return e
    }
    ...
    e._prefixes = m,
    e.testStyles = t,
    g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " w-mod-js w-mod-" + q.join(" w-mod-") : ""),
    e
}(this, this.document);
/**
 * Custom tests
